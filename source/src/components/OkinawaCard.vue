<template>
    <div>
        ...
        <div class="row">
            <div class="col-md-6 mb-4" v-for="item in okinawaProducts" :key="item.id">
        ...
        methods: {
            getProducts(page = 1){
                ...
                this.$http.get(api).then((response) => {
                    ...
                    vm.isLoading = false;
                    vm.okinawaProducts = response.data.products.filter(function(item){
                        return item.category == '沖繩';
                    });
                    console.log(vm.okinawaProducts)
