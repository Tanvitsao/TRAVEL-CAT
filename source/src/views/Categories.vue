                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="list-group sticky-top">
                            ...
                            <a href="#" @click.prevent="changeText('本州')" :class="{ 'active': text === '本州'}" class="list-group-item list-group-item-action"><i class="fas fa-torii-gate mr-2"></i>本州</a>
                            <a href="#" @click.prevent="changeText('北海道')" :class="{ 'active': text === '北海道'}" class="list-group-item list-group-item-action"><i class="fas fa-torii-gate mr-2"></i>北海道</a>
                            <a href="#" @click.prevent="changeText('四國')" :class="{ 'active': text === '四國'}" class="list-group-item list-group-item-action"><i class="fas fa-torii-gate mr-2"></i>四國</a>
                            <a href="#" @click.prevent="changeText('九州')" :class="{ 'active': text === '九州'}" class="list-group-item list-group-item-action"><i class="fas fa-torii-gate mr-2"></i>九州</a>
                            <a href="#" @click.prevent="changeText('沖繩')" :class="{ 'active': text === '沖繩'}" class="list-group-item list-group-item-action"><i class="fas fa-torii-gate mr-2"></i>沖繩</a>
                        </div>
                    </div>
                    <div class="col-md-9">
                        <!-- card -->
